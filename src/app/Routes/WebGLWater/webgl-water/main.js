...
export default function loadEverything() {
  ...
  window.center = window.oldCenter = new GL.Vector(-0.4, -0.75, 0.2);
  window.velocity = new GL.Vector();
  window.gravity = new GL.Vector(0, -4, 0);
  window.radius = 0.25;
